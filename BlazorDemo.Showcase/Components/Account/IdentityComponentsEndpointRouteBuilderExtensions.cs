...
using BlazorDemo.Showcase.Components.Account.Pages;
using BlazorDemo.Showcase.Components.Account.Pages.Manage;
        ...
        public static IEndpointConventionBuilder MapAdditionalIdentityEndpoints(this IEndpointRouteBuilder endpoints) {
            ...
            accountGroup.MapPost("/PerformExternalLogin", (
                ...
                var redirectUrl = UriHelper.BuildRelative(context.Request.PathBase, "Account/ExternalLogin",
                    QueryString.Create(query.Select(x => x.ToKeyValuePair).ToList()));
            ...
            manageGroup.MapPost("/LinkExternalLogin", async (
                ...
                var redirectUrl = UriHelper.BuildRelative(context.Request.PathBase, "Account/Manage/ExternalLogins",
